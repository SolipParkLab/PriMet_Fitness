...
# Saving
write.table(full_output, './DATA/ANALYSIS_DATA/2way__T/2wT_PvsM_Tarone-output.tsv',
...
saveRDS(false_output_concat, './DATA/ANALYSIS_DATA/2way__T/2wT_PvsM_Tarone-randomization-output.RDS')
...
# Saving file
write.table(tarone_res, './DATA/ANALYSIS_DATA/2way__T/2wT_PvsM_Tarone-output-adj-pval.tsv',
            sep = '\t', row.names = F, quote = F)
